...
export const classGroups = mysqlTable("class_groups", {
  ...
  /** Year group: infantil | lower_primary | junior | primary | secondary */
  yearGroup: mysqlEnum("yearGroup", ["infantil", "lower_primary", "junior", "primary", "secondary"]).default("secondary"),
