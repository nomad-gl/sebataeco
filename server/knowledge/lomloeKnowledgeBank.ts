...
export const LOMLOE_QUESTIONS: LomloeQuestion[] = [
  {
    ...
    competency: 'CCL',
    yearGroup: 'secondary',
    question: `Analyse how Shakespeare uses the soliloquy in 'Hamlet' to reveal character.`,
    options: [`To show Hamlet is mad`, `To give the audience direct insight into Hamlet's inner conflict and reasoning`, `To entertain the audience with poetry`, `To summarise the plot`],
    correctIndex: 1,
  },
  {
    id: 'q002',
  ...
  },
  {
    ...
    options: [`A simile uses 'like' or 'as'; a metaphor does not`, `A metaphor uses 'like'; a simile does not`, `They are the same thing`, `A simile is longer than a metaphor`],
    correctIndex: 0,
  },
  {
    id: 'q007',
  ...
  },
  {
    ...
    options: [`Run`, `Apple`, `Happy`, `Quickly`],
    correctIndex: 1,
  },
  {
    id: 'q012',
  ...
  },
  {
    ...
    competency: 'CP',
    yearGroup: 'secondary',
    question: `What is the difference between a 'dialect' and a 'register'?`,
    options: [`A dialect is a formal variety; a register is a regional variety`, `A dialect is a regional variety of a language; a register is a style adapted to context`, `They are the same thing`, `A register is only used in writing`],
    correctIndex: 1,
  },
  {
    id: 'q017',
  ...
  },
  {
    ...
    options: [`Germanic`, `Slavic`, `Romance`, `Celtic`],
    correctIndex: 2,
  },
  {
    id: 'q022',
  ...
  },
  {
    ...
    competency: 'STEM',
    yearGroup: 'secondary',
    question: `A train travels 240 km in 1.5 hours. What is its average speed?`,
    options: [`120 km/h`, `160 km/h`, `180 km/h`, `200 km/h`],
    correctIndex: 1,
  },
  {
    id: 'q032',
  ...
  },
  {
    ...
    options: [`A type of robot that learns to walk`, `A branch of AI where systems learn from data to improve without explicit programming`, `A method of teaching programming to students`, `A type of computer hardware`],
    correctIndex: 1,
  },
  {
    id: 'q047',
  ...
  },
  {
    ...
    options: [`A type of fishing sport`, `A scam to steal personal information online`, `A way to share files`, `A social media platform`],
    correctIndex: 1,
  },
  {
    id: 'q052',
  ...
  },
  {
    ...
    competency: 'CD',
    yearGroup: 'junior',
    question: `What should you do if a stranger online asks for your address?`,
    options: [`Tell them`, `Ask a trusted adult`, `Send a photo`, `Ignore and forget`],
    correctIndex: 1,
  },
  {
    id: 'q057',
  ...
  },
  {
    ...
    options: [`The ability to memorise facts quickly`, `Thinking about one's own thinking and learning processes`, `A type of intelligence test`, `The study of memory in psychology`],
    correctIndex: 1,
  },
  {
    id: 'q062',
  ...
  },
  {
    ...
    options: [`Believing intelligence is fixed`, `Believing abilities can improve with effort`, `Focusing only on grades`, `Avoiding challenges`],
    correctIndex: 1,
  },
  {
    id: 'q067',
  ...
  },
  {
    ...
    competency: 'CPSAA',
    yearGroup: 'junior',
    question: `If a friend is sad, what is a kind thing to do?`,
    options: [`Laugh at them`, `Walk away`, `Ask if they are okay`, `Ignore them`],
    correctIndex: 2,
  },
  {
    id: 'q072',
  ...
  },
  {
    ...
    competency: 'CC',
    yearGroup: 'secondary',
    question: `What is the difference between a 'direct democracy' and a 'representative democracy'?`,
    options: [`In a direct democracy, citizens vote on laws directly; in a representative democracy, elected officials vote on their behalf`, `They are the same`, `A representative democracy has no elections`, `A direct democracy is only used in large countries`],
    correctIndex: 0,
  },
  {
    id: 'q077',
  ...
  },
  {
    ...
    options: [`A law only for adults`, `A document listing basic rights for all people`, `A type of international treaty for trade`, `A school curriculum`],
    correctIndex: 1,
  },
  {
    id: 'q082',
  ...
  },
  {
    ...
    options: [`Something you can ignore`, `An instruction everyone must follow`, `A type of game`, `A school subject`],
    correctIndex: 1,
  },
  {
    id: 'q087',
  ...
  },
  {
    ...
    options: [`A type of government grant`, `Private investment provided to early-stage, high-growth companies in exchange for equity`, `A type of bank loan`, `Money raised through crowdfunding`],
    correctIndex: 1,
  },
  {
    id: 'q092',
  ...
  },
  {
    ...
    options: [`A list of products to buy`, `A document outlining goals, strategies, and finances for a business`, `A timetable for school`, `A type of bank account`],
    correctIndex: 1,
  },
  {
    id: 'q097',
  ...
  },
  {
    ...
    competency: 'CE',
    yearGroup: 'junior',
    question: `If you want to sell lemonade, what do you need to do first?`,
    options: [`Spend all your money`, `Make a plan`, `Tell everyone it is ready`, `Wait for someone to ask`],
    correctIndex: 1,
  },
  {
    id: 'q102',
  ...
  },
  {
    ...
    competency: 'CCEC',
    yearGroup: 'secondary',
    question: `What is 'postmodernism' in art and culture?`,
    options: [`A movement that strictly follows classical rules`, `A movement that questions grand narratives, blurs boundaries between high and low culture, and embraces irony`, `A type of abstract painting`, `A movement focused only on realism`],
    correctIndex: 1,
  },
  {
    id: 'q107',
  ...
  },
  {
    ...
    competency: 'CCEC',
    yearGroup: 'primary',
    question: `Which artistic movement is Pablo Picasso associated with?`,
  ...
  },
  {
    ...
    options: [`Trumpet`, `Drum`, `Violin`, `Flute`],
    correctIndex: 2,
  },
  {
    id: 'q117',
