...
export const VIDEO_BACKGROUNDS: VideoBackground[] = [
  ...
  { id: "bg-01", label: "Classroom", url: "/manus-storage/bg-01-classroom_b45bd275_ef195690.jpg" },
  { id: "bg-02", label: "Library", url: "/manus-storage/bg-02-library_cc3b079f_5b727d50.jpg" },
  { id: "bg-03", label: "Catalonia", url: "/manus-storage/bg-03-catalonia_a24363ef_0aec9028.jpg" },
  { id: "bg-04", label: "Courtyard", url: "/manus-storage/bg-04-courtyard_f81e8016_4814ec02.jpg" },
  { id: "bg-05", label: "Abstract Blue", url: "/manus-storage/bg-05-abstract-blue_fd46ab68_dfba1577.jpg" },
  { id: "bg-06", label: "Barcelona", url: "/manus-storage/bg-06-barcelona-Wf3QUJdS7WPN29uTKr7qav_668b4bda.png" },
  { id: "bg-07", label: "Science Lab", url: "/manus-storage/bg-07-science-lab-Gay5oLWMQi2ccbPZGm42S8_362d4c0d.png" },
  { id: "bg-08", label: "Art Studio", url: "/manus-storage/bg-08-art-studio-DVsJVSciMSeRXpYEjBaYad_d1de1b5f.png" },
  { id: "bg-09", label: "Pyrenees", url: "/manus-storage/bg-09-pyrenees-V2FjMAQKmdtbnZdUbjjX8A_c2db83d8.png" },
  { id: "bg-10", label: "Teal Gradient", url: "/manus-storage/bg-10-teal-gradient-LcHZKywxrZgr2u3qtomQLZ_4306953b.png" },
  { id: "bg-11", label: "Music Room", url: "/manus-storage/bg-11-music-room-GycarnkuSLvrRYwwJ48VuR_7e569456.png" },
  { id: "bg-12", label: "Computer Lab", url: "/manus-storage/bg-12-computer-lab-Nxysp88rNEqu76ewiUp4sA_d9e54b9e.png" },
  { id: "bg-13", label: "Costa Brava", url: "/manus-storage/bg-13-costa-brava-N9RUEy6uGm9wckyFbPhWP9_5190f46d.png" },
  { id: "bg-14", label: "Home Office", url: "/manus-storage/bg-14-warm-office-ZRCB6ZSn3MwEJsHyygMzKK_a4e000e5.png" },
  { id: "bg-15", label: "Purple Gradient", url: "/manus-storage/bg-15-purple-gradient-itWjW5taXja6WghCiASWUw_bd807536.png" },
  { id: "bg-16", label: "Gymnasium", url: "/manus-storage/bg-16-gym-HWEf9LC2wnCtSP3TyS293W_6a3477bc.png" },
  { id: "bg-17", label: "Montserrat", url: "/manus-storage/bg-17-montserrat-P9m4fwi6hBAYDDdHtvLh2n_b2731811.png" },
  { id: "bg-18", label: "Garden", url: "/manus-storage/bg-18-garden-ZiRHFepgTHCGigwYK9hQuh_3d4f0b43.png" },
  { id: "bg-19", label: "Castle", url: "/manus-storage/bg-19-castle-imMyRbpiwyCkfsSSzNVHJg_20e7883e.png" },
  { id: "bg-20", label: "Amber Gradient", url: "/manus-storage/bg-20-amber-gradient-RrWHc6fdr5Haz2kGm9kub7_05529757.png" },
];
    ...
    <div className="flex flex-col h-full bg-gray-950 text-white select-none">
      ...
      <div className="flex items-center justify-between px-6 py-3 bg-gray-900 border-b border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-sm font-bold text-white leading-none">AINA <span className="text-white/50 font-light">|</span> Meet</p>
            {channelName && (
              <p className="text-xs text-gray-300 mt-0.5">Call with <span className="font-semibold text-white">{channelName}</span></p>
            )}
          </div>
        </div>
        {schoolLogoUrl && (
