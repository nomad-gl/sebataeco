...
export const VIDEO_BACKGROUNDS: VideoBackground[] = [
  ...
  { id: "bg-01", label: "Classroom", url: "/manus-storage/bg-01-classroom_6d96e02b.jpg" },
  { id: "bg-02", label: "Library", url: "/manus-storage/bg-02-library_1e0960cd.jpg" },
  { id: "bg-03", label: "Catalonia", url: "/manus-storage/bg-03-catalonia_c0afdcb3.jpg" },
  { id: "bg-04", label: "Courtyard", url: "/manus-storage/bg-04-courtyard_0a49be1b.jpg" },
  { id: "bg-05", label: "Abstract Blue", url: "/manus-storage/bg-05-abstract-blue_2cdff938.jpg" },
  { id: "bg-06", label: "Barcelona", url: "/manus-storage/bg-06-barcelona_1d547231.jpg" },
  { id: "bg-07", label: "Science Lab", url: "/manus-storage/bg-07-science-lab_a6c2b150.jpg" },
  { id: "bg-08", label: "Art Studio", url: "/manus-storage/bg-08-art-studio_6b2a4d0b.jpg" },
  { id: "bg-09", label: "Pyrenees", url: "/manus-storage/bg-09-pyrenees_b9d5917c.jpg" },
  { id: "bg-10", label: "Teal Gradient", url: "/manus-storage/bg-10-teal-gradient_86165507.jpg" },
  { id: "bg-11", label: "Music Room", url: "/manus-storage/bg-11-music-room_8037644e.jpg" },
  { id: "bg-12", label: "Computer Lab", url: "/manus-storage/bg-12-computer-lab_d007a599.jpg" },
  { id: "bg-13", label: "Costa Brava", url: "/manus-storage/bg-13-costa-brava_30ec50e7.jpg" },
  { id: "bg-14", label: "Home Office", url: "/manus-storage/bg-14-warm-office_bbea4c4d.jpg" },
  { id: "bg-15", label: "Purple Gradient", url: "/manus-storage/bg-15-purple-gradient_e73ca6ae.jpg" },
  { id: "bg-16", label: "Gymnasium", url: "/manus-storage/bg-16-gym_efdef13c.jpg" },
  { id: "bg-17", label: "Montserrat", url: "/manus-storage/bg-17-montserrat_badde249.jpg" },
  { id: "bg-18", label: "Garden", url: "/manus-storage/bg-18-garden_61d95b80.jpg" },
  { id: "bg-19", label: "Castle", url: "/manus-storage/bg-19-castle_f148ccce.jpg" },
  { id: "bg-20", label: "Amber Gradient", url: "/manus-storage/bg-20-amber-gradient_5393e220.jpg" },
];
