      ...
      <div className="fixed bottom-4 left-4 right-4 z-50 max-w-md mx-auto">
        <div className="bg-[#0f172a] border border-white/20 rounded-2xl shadow-2xl p-4 flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm font-semibold text-white">{t("pwa_android_title")}</p>
      ...
      <div className="fixed bottom-4 left-4 right-4 z-50 max-w-md mx-auto">
        <div className="bg-[#0f172a] border border-white/20 rounded-2xl shadow-2xl p-4">
          <div className="flex items-start justify-between gap-2 mb-3">
            <p className="text-sm font-semibold text-white">{t("pwa_ios_title")}</p>
            <button
              onClick={handleDismiss}
              className="flex-shrink-0 text-white/40 hover:text-white transition-colors"
              aria-label={t("pwa_dismiss")}
          ...
          <ol className="space-y-2">
            <li className="flex items-center gap-2 text-xs text-white/70">
              ...
              <span>{t("pwa_ios_step1_pre")} <Share className="size-3.5 inline-block mx-0.5 text-blue-400" /> {t("pwa_ios_step1_post")}</span>
            </li>
            <li className="flex items-center gap-2 text-xs text-white/70">
              ...
              <span>{t("pwa_ios_step2_pre")} <strong className="text-white">{t("pwa_ios_step2_action")}</strong> <Plus className="size-3 inline-block ml-0.5" /></span>
            </li>
            <li className="flex items-center gap-2 text-xs text-white/70">
              ...
              <span>{t("pwa_ios_step3_pre")} <strong className="text-white">{t("pwa_ios_step3_action")}</strong> {t("pwa_ios_step3_post")}</span>
            </li>
          </ol>
