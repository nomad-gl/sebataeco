      ...
      <div className="container py-4 sm:py-8 flex flex-col gap-6 sm:gap-8">
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-base flex items-center gap-2">
              ...
              {t("admin_kb_generate_title")}
            </CardTitle>
          </CardHeader>
          <CardContent className="pt-0 space-y-3">
            <p className="text-sm text-muted-foreground">
              {t("admin_kb_generate_desc")}
            ...
            >
              {generateMutation.isPending ? (
                ...
                <><Zap className="w-4 h-4" /> {t("admin_kb_generate_btn")}</>
              )}
            </Button>
          </CardContent>
        </Card>
        ...
        {(pendingQuestions && pendingQuestions.length > 0) && (
          <Card>
            ...
            <CardContent className="flex flex-col gap-3">
              <p className="text-sm text-muted-foreground">{t("admin_kb_review_desc")}</p>
              <div className="flex flex-col gap-2">
