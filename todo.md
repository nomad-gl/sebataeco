...
## Feature: Academic Calendar Search Bar (2026-05-09)
- [x] Add search input field to Academic Calendar page
- [x] Implement client-side filtering for teacher names
- [x] Add visual feedback for search results (empty state message)
- [x] Support multi-language search (EN, ES, CA) with translation keys
